    ...
    if setting=='def':
        ...
        if dr_tech=='DiffRed':
            if not os.path.exists(os.path.join(save_path,f'{dataset}.xlsx')):
                ...
                diffred_df=pd.read_excel(os.path.join(RES_DIR, f'{dataset}_{metric}_results.xlsx'))
            ...
            if not os.path.exists(os.path.join(save_path,f'{dataset}.xlsx')):
                ...
                for target_dim in target_dims:
                    ...
                    rmap_df=pd.read_excel(os.path.join(OTHER_RES_DIR, dr_tech, dataset, f'{dataset}_{dr_tech}_{metric}_results_{target_dim}.xlsx'))
            ...
            if not os.path.exists(os.path.join(save_path,f'{dataset}.xlsx')):
                ...
                metric_df=pd.read_excel(os.path.join(OTHER_RES_DIR, dr_tech, f'{dataset}_{dr_tech}_{metric}_results.xlsx'))
