...
def parse_arguments():
    ...
    parser.add_argument('--save_dir', '-s', help='Path to the directory where rmap embeddings are to be saved', default='./rmap_embeddings')
    ...
    parser.add_argument('--eta', type=int, help='Number of instances of RMap to be computed for generating confidence interval', default=20)
