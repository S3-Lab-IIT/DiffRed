...
datasets="Cifar10 FMnist Reuters30k geneRNASeq"
...
for dataset in $datasets; do
    ...
    update_progress_description $dataset
        ...
        python3 compute_stress.py --save_dir $save_dir --embed_dir $embed_dir --file_name stress_results_RMap --dataset $dataset --dr_tech RMap --setting def --target_dims $bank_t_value --dr_args 20
    else
       python3 compute_stress.py --save_dir $save_dir --embed_dir $embed_dir --file_name stress_results_RMap --dataset $dataset --dr_tech RMap --setting def --target_dims $common_t_value --dr_args 20
    fi
