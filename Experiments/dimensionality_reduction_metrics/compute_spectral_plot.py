...
def parse_arguments():
    ...
    parser.add_argument('--energy_threshold', '-e', help='List of energy thresholds to annotate seperated by space. \'None\' for plotting without energy thresholds. ', default='0.90 0.95 0.98 0.99')
